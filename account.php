...
<nav class="navbar navbar-default title1">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#"><b>Exam Portal</b></a>
    </div>
...
<center><h1 class="title" style="color:red">***Result ***   Thanks for giving this quiz</h1><center><br /><table class="table table-striped title1" style="font-size:20px;font-weight:1000;">';
...
<a href="about.php" data-toggle="modal" data-target="#login">Admin Login</a></div>
